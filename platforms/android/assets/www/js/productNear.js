...
var app = {
    ...
    //
    successCB:function() {  
		alert("Coupon correctly redeemed, now you can enter and enjoy your shopping!", function() {}, "","OK");
    },
		...
		if (xmlhttp.readyState==4) {
			if (xmlhttp.status==200) { 
				...
				while(i<xmlDoc.getElementsByTagName('picture').length){
					...
					//htmlContent=htmlContent+"<div class='swiper-slide'><a href='productFarDetail.html?id=1'><img width='100%' src='"+picture+"'></a>"+name+"</div>";
					//pages = "<div data-role='page' id='1'><div data-role='header' data-position='fixed'><h1>LaPS App</h1></div><div data-role='content'>MARIOOOO</div></div>";
				...
				//document.getElementsByTagName("body").item(0).innerHTML = document.getElementsByTagName("body").item(0).innerHTML + pages;
				app.loadSwiper()
			}
			else {
				alert("Server error");
